...
const testimonials: Testimonial[] = [
  {
    ...
    name: "Анна М.",
    rating: 5,
    text: "Потрясающая работа! Брови выглядят естественно и держатся очень долго. Марина настоящий профессионал своего дела.",
    date: "2 недели назад"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    name: "Мария С.",
    rating: 5,
    text: "Идеальная форма бровей! Марина учла все мои пожелания и сделала именно то, что я хотела. Рекомендую!",
    date: "3 недели назад"
  },
  {
    id: 4,
